            ...
            <div class="sidebar" id="sidebar-toggle">
                ...
                <div class="sidebar-content">
                    <ul>
                        ...
                        <li>
                            <a href="records.php" id="active"><i class="fa-solid fa-coins"></i><span>Records</span></a>
                        </li>
                        <li>
                        ...
                        <form action="" method="POST">
                            <div class="filter">
                                ...
                                <div class="search-filter">
                                    <select name="" id="records_grade">
                                        <option value="">--select grade--</option>
                                    </select>
                                    <select name="" id="records_section">
                                        <option value="">--select section--</option>
                                    </select>
                                    <div class="input-group-search">
                                        <i class="fa-brands fa-searchengin"></i>
                                        <input type="text" placeholder="search" id="records_search">
                                    </div>
                                </div>
                            </div>
                            <div class="records-table" id="scrollbar">
